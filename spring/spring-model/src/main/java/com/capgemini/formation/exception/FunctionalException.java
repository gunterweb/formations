...
public class FunctionalException extends FormationException {
     ...
     *            the reason
     */
    public FunctionalException(FunctionalReason functionalReason, Object... args) {
        super();
     ...
     *            Exception
     */
    public FunctionalException(FunctionalReason functionalReason, Exception e, Object... args) {
        super(e);
        this.functionalReason = functionalReason;
        this.args = args;
    }
